   ...
   error_reporting(E_ALL ^ E_NOTICE);  
	...
	public static function correct($word) {
		...
		if(empty(self::$NWORDS)) {
			...
			if(!file_exists('/home/rakesh/Downloads/serialized_dictionary.txt')) {

				self::$NWORDS = self::train(self::words(file_get_contents("/home/rakesh/big.txt")));

				$fp = fopen("/home/rakesh/Downloads/serialized_dictionary.txt","w+");
				...
				self::$NWORDS = unserialize(file_get_contents("/home/rakesh/Downloads/serialized_dictionary.txt"));
